...
ol.proj.get("EPSG:3384").setExtent([-6961.010795, 52163.286417, -5881.390108, 52884.674926]);
var wms_layers = [];
...
lyr_LOT_PARCEL_2.set('fieldLabels', {'NEGERI': 'inline label', 'DAERAH': 'inline label', 'MUKIM': 'header label', 'SEKSYEN': 'inline label', 'LOT': 'inline label', 'UPI': 'no label', 'KELUASAN': 'inline label', 'KOD_KEGUNA': 'no label', 'PA': 'inline label', 'STATUS': 'header label', 'NOFAILUKUR': 'header label', 'NAMAPEMILI': 'no label', 'ALAMATPEMI': 'no label', 'GUID': 'no label', 'TARIKH_KEM': 'no label', 'MI_PRINX': 'no label', 'FASA': 'no label', 'BLOCK': 'no label', 'CLASS': 'no label', 'KOD_TUJUAN': 'no label', 'KELUASAN_P': 'no label', 'KOD_UNITLU': 'no label', });
lyr_BOUNDARY_MARKING_3.set('fieldLabels', {'ID_BATU': 'no label', 'UTARA': 'header label', 'TIMUR': 'header label', 'UTARA_RSO': 'header label', 'TIMUR_RSO': 'header label', });
